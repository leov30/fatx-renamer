...
echo -----------------------------------------------------
echo 1. Use short country tags * ^(USA^) ^> ^(U^)
echo 2. keep Parethesis tags, and make title short *
echo 3. Remove Parenthesis tags
echo 4. Simple FATx renaming, will chop tags ^(Default^)
echo.
